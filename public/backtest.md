...
_30 tickers · 5y history · horizon 10 trading days · 34,553 signal-bars_
...
|---|---|---|---|---|
| ≥ 60 (coiled) | 6,405 | 5.4% | 1.17× | 47% |
| 30 – 60 | 14,017 | 5.4% | 0.97× | 38% |
| < 30 | 14,131 | 5.8% | 0.75× | 27% |
...
(5.4% vs 5.8%, Δ -0.5 pts; score↔|move| r = -0.03) — as expected,
...
|---|---|---|---|---|
| squeeze ON | 2,684 | 5.4% | 1.09× | 44% |
| squeeze OFF | 31,869 | 5.6% | 0.90× | 34% |
